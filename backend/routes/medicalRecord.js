...
const service = require("../controllers/medicalRecordController");
...
router.delete(
  "/deleteImgRec/:medicalImageId/:doctorId",
  service.deleteImageFromMedicalRecord
);
router.delete(
  "/deleteAlergyRec/:allergyId/:doctorId",
  service.deleteAllergyFromMedicalRecord
);
router.delete(
  "/deleteMedicationRec/:medicationId/:doctorId",
  service.deleteMedicationFromMedicalRecord
);
router.delete(
  "/deleteTreatmentRec/:treatmentId/:doctorId",
  service.deleteTreatmentFromMedicalRecord
);
