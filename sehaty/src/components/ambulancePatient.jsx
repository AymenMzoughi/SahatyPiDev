                    ...
                    if (ambulance.available) {
                        return (
                            <tr key={ambulance._id}>
                              <td>  {ambulance.name} - Available:{" "}</td>
                              <td> {ambulance.available.toString()}</td>
                              <td>
        ...
        {ambulances.map((ambulance) => {
          if (!ambulance.available) {
            return (
             ...
             <td>   {ambulance.name} - Available:{" "}</td>
             <td>  {ambulance.available.toString()}</td>
             <td>  <button onClick={() => unreserve(ambulance._id)}>
                  Unreserve
                </button>
                </td>
              </tr>
      ...
      {showAlert && (
        ...
        >
          {alertMessage}
                ...
                <Button className="btn btn-outline-primary" variant="primary" onClick={() => { setShowMapModal(true); console.log(getUserPosition(ambulanceId)) }} >Open Map</Button>
                </div>
